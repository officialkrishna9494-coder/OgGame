...
// 3s; the ✕ lets anyone clear it sooner.
    ...
    <div className="pointer-events-none absolute inset-0 z-40">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="animate-pop-in pointer-events-auto w-full max-w-xs rounded-[24px] border-2 border-[#ff3b3b] bg-white/95 p-5 text-center shadow-[0_0_60px_-10px_rgba(255,59,59,0.7)]">
          ...
          <button
            onClick={onClose}
            className="mt-3 w-full rounded-2xl bg-[#b01212] py-2.5 text-[13px] font-bold text-white transition-transform hover:bg-[#8f0e0e] active:scale-[0.98]"
          >
            ✕ got it, stand down
          </button>
        </div>
